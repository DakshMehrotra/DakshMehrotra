...
<img src="https://komarev.com/ghpvc/?username=DakshMehrotra&label=PROFILE+ACCESSES&color=00ff88&style=flat-square" alt="profile views" />

</div>

---

## SYSTEM CONFIGURATION (ABOUT ME)

<table width="100%">
  <tr>
    <td width="55%" valign="top">
      <h3>Profile Overview</h3>
      <p>I am Daksh Mehrotra, a Cloud and Machine Learning Engineer pursuing a B.Tech in Computer Science and Engineering at UPES Dehradun. Currently executing advanced research as a Nanoelectronics R&amp;D Intern at IIT Roorkee.</p>
      <ul>
        <li><b>Base Locator:</b> Dehradun, Uttarakhand, India</li>
        <li><b>Academic Track:</b> B.Tech CSE @ UPES Dehradun</li>
        <li><b>Core Focus:</b> Designing and scaling intelligent Cloud, ML, and DevOps architectures</li>
      ...
      <p><i>If offline, system state is sleeping.</i></p>
    </td>
    <td width="45%" valign="top">
      <h3>System Milestones</h3>
      <ul>
